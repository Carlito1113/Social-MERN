...
export default function Register() {
  ...
  const onChange = e => setFormData({ ...formData, [e.target.name]: e.target.value, [e.target.email]: e.target.value, [e.target.password]: e.target.value, [e.target.password2]: e.target.value });
